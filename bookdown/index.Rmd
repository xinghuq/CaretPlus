--- 
title: "Introduction of the `caret` Package and "CaretPlus" "
subtitle: ""CaretPlus" used for "DeepGenomeScan""
author: ""This documentation updates the intruduction of the "caret" package authored by Max Kuhn, additionally, the updates syn in "CaretPlus"" compatible with "DeepGenomeScan" "
date: "`r Sys.Date()`"
...
# Introduction
This documentation updates the intruduction of the "caret" package authored by Max Kuhn, additionally, the updates syn in "CaretPlus".
...
The current release version can be found on [CRAN](http://cran.r-project.org/web/packages/caret/) and the project is hosted [on github](https://github.com/topepo/caret), and the "CaretPlus" including CNN and its importance metrics is hosted on[github](https://github.com/xinghuq/CaretPlus).
...
You can always email [me](mailto:qinxinghu@gmail.com) with questions,comments or suggestions.
