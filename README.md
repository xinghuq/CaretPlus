...
This repository is forked from topepo/caret, currently it is a modified version for adapting to DeepVariantScan which added CNN and it's importance estimation. The original caret package can't accomodate some smooth runing functions for DeepVariantScan becasue of some bugs. 
